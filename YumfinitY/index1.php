...
<body>
	...
	<div class="container">
		...
		<div class="restaura-heading">
		      ...
		      <h3 style="font-family: 'Acme', sans-serif;font-size: 64px" class="text-dark text-center">Top homecooks</h3>
	  ...
	  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header bgclr">
		        <h5 class="modal-title text-white" id="exampleModalLabel">Client</h5>
	...
	<div class="modal fade" id="registerClient" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header bgclr">
