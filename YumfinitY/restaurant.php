<?php
	...
	$query = "SELECT * FROM homecook WHERE id = $homecook_id ";
		...
		<div class="mt-5 text-center mb-5">
		 ...
		 <div class="menu-list">
		 	...
		 	<?php
		 		...
		 		$query2 = "SELECT * FROM food WHERE cook_id = $homecook_id";
		...
		<div class="review-section">
		 	...
		 	<div class="review-row">
		 		...
		 		<?php
		 			...
		 			$query3 = "SELECT * FROM review r INNER JOIN users s ON r.user_id=s.user_id WHERE homecook_id = $homecook_id";
	  ...
	  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        ...
		        <form action="add_review.php?homecook_id=<?php echo $homecook_id; ?>" method="POST">
