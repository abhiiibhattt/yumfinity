...
$query = "SELECT * FROM client WHERE client_id LIKE '$client_id'";
$result = mysqli_query($conn,$query);
$fetched_result = mysqli_fetch_assoc($result);
$name = $fetched_result['name'];
$email = $fetched_result['email'];
$profile_pic = $fetched_result['profile_pic'];
$query2 = "SELECT * FROM client_details WHERE client_id LIKE '$client_id'";
...
<body>
	...
	<div class="container emp-profile">
            <form method="post" action="client_pic.php" enctype="multipart/form-data">
                <div class="row">
